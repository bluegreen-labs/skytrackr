...
The routine uses model optimization and parameter estimation to determine locations robustly using a template matching approach and behaviourally informed constraints.
