...
cc876 |> stk_profile()
```
You can also use the `stk_filter()` with the `plot` parameter set to TRUE (which gives you a diurnal profile). This function also allows you to set the `range` parameter, i.e. which values you consider to be twilight and want to include in the analysis.
